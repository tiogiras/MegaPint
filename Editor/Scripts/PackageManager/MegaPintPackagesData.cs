...
public static class MegaPintPackagesData
{
    ...
    public static readonly List <MegaPintPackageData> Packages = new()
    {
        new MegaPintPackageData
        {
            ...
            GitUrl = "https://github.com/tiogiras/MegaPint-AutoSave.git#05ecf1bee9d8daa572b99ea5272241a85dcb1d04",
            Version = "1.0.0",
        ...
        new MegaPintPackageData
        {
            ...
            GitUrl = "https://github.com/tiogiras/MegaPint-Validators.git#b0b3941b0ef466ee766d949a6eba65a789f77d36",
            Version = "1.0.0",
            LastUpdate = "10.01.2024",
            UnityVersion = "2022.3.15f1 or higher",
            MegaPintVersion = "1.0.0 or higher",
