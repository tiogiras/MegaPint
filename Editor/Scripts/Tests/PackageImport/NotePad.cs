...
/// <summary> Unit tests testing the import of the NotePad package </summary>
internal class NotePad
{
    ...
    public IEnumerator ImportPackage()
    {
        ...
        Task <bool> task = TestsUtility.ImportPackage(PackageKey.NotePad);
    ...
    public IEnumerator RemovePackage()
    {
        ...
        Task <bool> task = TestsUtility.RemovePackage(PackageKey.NotePad);
