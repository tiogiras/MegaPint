...
/// <summary> Unit tests testing the import of the Screenshot package </summary>
internal class Screenshot
{
    ...
    public IEnumerator ImportPackage()
    {
        ...
        Task <bool> task = TestsUtility.ImportPackage(PackageKey.Screenshot);
    ...
    public IEnumerator RemovePackage()
    {
        ...
        Task <bool> task = TestsUtility.RemovePackage(PackageKey.Screenshot);
