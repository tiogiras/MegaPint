...
/// <summary> Unit tests testing the import of the AutoSave package </summary>
internal class AutoSave
{
    ...
    public IEnumerator ImportPackage()
    {
        ...
        Task <bool> task = TestsUtility.ImportPackage(PackageKey.AutoSave);
    ...
    public IEnumerator RemovePackage()
    {
        ...
        Task <bool> task = TestsUtility.RemovePackage(PackageKey.AutoSave);
